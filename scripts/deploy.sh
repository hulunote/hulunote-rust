...
build_frontend() {
    ...
    cp ./resources/public/html/hulunote.html ../hulunote-rust/resources/public/index.html
    cp ./resources/public/css/* ../hulunote-rust/resources/public/css/
    cp -r resources/public/img ../hulunote-rust/resources/public/
